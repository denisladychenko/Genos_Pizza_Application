...
public class AddRemoveCategoryImageSelectorForm extends JFrame{
	...
	public AddRemoveCategoryImageSelectorForm() {
		...
		rootNode = new DefaultMutableTreeNode("Categories");   //root node
	...
	public void createNodes(DefaultMutableTreeNode root) {
		...
		try {
			...
			String SQLStatement = "SELECT name, filename FROM images "
								+ "WHERE image_group LIKE ('category') "
								+ "ORDER BY name ASC";
