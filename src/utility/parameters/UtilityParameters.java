...
public class UtilityParameters {
	...
	public static final Color FRAME_COLOR = new Color(102,93,153);                          //main window frame color
	public static final Color PANELS_COLOR = new Color(120,100,255);                        //the color of the panels
	public static final Color POP_UP_MENU_PANEL_COLOR = new Color(189,212,249);             //"hotel or cabin" pop up menu color
